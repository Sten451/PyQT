...
from data_client.main_window_conv import Ui_MainClientWindow
from data_client.add_contact import AddContactDialog
from data_client.del_contact import DelContactDialog
